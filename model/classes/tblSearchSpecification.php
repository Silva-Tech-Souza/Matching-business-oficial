...
class SearchEspecification{
    ...
    public function cadastrar(){
        ...
        $sql = "INSERT INTO tblSearchSpecification ( idSearch, idNumEmpregados, idlRangeValue,idNivelOperacao,DataDeAbertura) 
        VALUES (:idSearch, :idNumEmpregados, :idlRangeValue,:idNivelOperacao,:DataDeAbertura)";
