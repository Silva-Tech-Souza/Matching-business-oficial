    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if (instance.options.search) {
                ...
                var doneButtonHtml = '<button type="button" id="doneButton" class="ms-done-button stylobutoninterno">Done</button>';
                optionsWrap.find('.ms-search input').after(doneButtonHtml);
                document.getElementById('doneButton').addEventListener('click', function() {
                    var element = document.getElementById('ms-list-1');
            ...
            optionsWrap.on('click', '#doneButton', function() {
                optionsWrap.removeClass('open'); // Fecha o componente
            });
        ...
        _updateSelectAllText: function() {
            ...
            // Adicione o botão "Done" acima da div "no-result-message"
