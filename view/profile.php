                  ...
                  <div class="col-12">
                    <div class="row" style="font-size: larger;">
                      ...
                      <div class="col-5 d-flex justify-content-end align-middle">
                        <p class="mb-0  color-branco"> <b><?php $data = new DateTime($AnoFundacao); echo $dataFormatada = $data->format('d/m/Y'); ?></b></p>
                      </div>
                      <hr>
                      <div class="col-7 d-flex justify-content-start">
                  ...
                  ?>
                      <div class="col-2 d-flex justify-content-start">
                        <img src="<?php if ($rowcolab1->PersonalUserPicturePath != "Avatar.png" && $rowcolab1->PersonalUserPicturePath != "" && $rowcolab1->PersonalUserPicturePath != null) {
                                    ...
                                    echo "";
                                  } ?>" alt="user" style="max-width: 42px; ;min-height: 35px;object-fit: cover;"class="nav-profile-img" onerror="this.onerror=null; this.src='assets/img/Avatar.png'">
