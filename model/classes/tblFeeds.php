...
class Feeds{
    ...
    public function setidIdFeed($param){$this->IdFeed = $param;}

    public function getidIdFeed(){return $this->IdFeed;}

    public function setidClient($param){$this->idClient = $param;}
    
    public function getidClient(){return $this->idClient;}

    public function setPublished_at($param){$this->Published_at = $param;}
    
    public function getPublished_at(){return $this->Published_at;}

    public function setTitle($param){$this->Title = $param;}
    ...
    public function setImage($param){$this->Image = $param;}
    
    public function getImage(){return $this->Image;}

    public function setVideo($param){$this->Video = $param;}
    ...
    public function cadastrar(){
        ...
        $sql = "INSERT INTO tblFeeds (IdFeed,idClient,Published_at,Title,Text,Image,Video) VALUES (:IdFeed,:idClient,:Published_at,:Title,:Text,:Image,:Video)";
